...
public:
    ...
    : Quadrilateral(n, p) {
        double side1_length = DistanceBetween(m_points[0], m_points[1]);
        double side2_length = DistanceBetween(m_points[1], m_points[2]);
        double side3_length = DistanceBetween(m_points[2], m_points[3]);
        double side4_length = DistanceBetween(m_points[3], m_points[0]);
        if (!EqualSides(side1_length, side2_length) ||
            !EqualSides(side3_length, side4_length)) throw 1210;
    }
};
...
public:
    ...
    : Quadrilateral(n, p) {
        ...
        double angle3 = Angle(m_points[2],m_points[3], m_points[0]);
        double angle4 = Angle(m_points[3],m_points[0], m_points[1]);
        if (!EqualAngles(angle1, angle3) || !EqualAngles(angle2, angle4))
            throw 1210;
    }
};
...
public:
    ...
    : Quadrilateral(n, p), Trapezoid(n, p) {
        double side1_length = DistanceBetween(m_points[0], m_points[1]);
        double side2_length = DistanceBetween(m_points[1], m_points[2]);
        double side3_length = DistanceBetween(m_points[2], m_points[3]);
        double side4_length = DistanceBetween(m_points[3], m_points[0]);
        if (!EqualSides(side1_length, side3_length) ||
            !EqualSides(side2_length, side4_length)) throw 1210;
    }
};
...
public:
    ...
    : Quadrilateral(n, p), Parallelogram(n, p) {
        ...
        double side4_length = DistanceBetween(m_points[3], m_points[0]);
        if (!EqualSides(side1_length, side2_length) ||
            !EqualSides(side2_length, side3_length) ||
            !EqualSides(side3_length, side4_length)) throw 1210;
    }
};
